...
onready var module_line_editor := ($AddModuleDialog/ModuleNameLineEditor as LineEdit)
onready var module_lang_line_editor := ($AddModuleDialog/LangLineEditor as LineEdit)
